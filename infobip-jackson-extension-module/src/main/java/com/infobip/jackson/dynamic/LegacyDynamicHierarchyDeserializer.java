...
public class LegacyDynamicHierarchyDeserializer<T> extends JsonDeserializer<T> {
    ...
    public LegacyDynamicHierarchyDeserializer(Class<T> hierarchyRootType, List<JsonValueToJavaTypeJacksonMapping<T>> mappings) {
        this(hierarchyRootType, mappings, "type");
    }

    public LegacyDynamicHierarchyDeserializer(Class<T> hierarchyRootType, List<JsonValueToJavaTypeJacksonMapping<T>> mappings, String jsonValuePropertyName) {
